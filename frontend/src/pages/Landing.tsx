            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              {vendor?.loginTitle && (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">{vendor.loginTitle}</h3>
                    <p className="mt-1 text-sm text-gray-600">{vendor.loginDescription}</p>
                  </div>
                </a>
              )}
